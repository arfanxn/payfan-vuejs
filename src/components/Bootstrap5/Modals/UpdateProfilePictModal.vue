                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-5 pb-5 d-flex flex-column text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            <UserAvatar :user="AuthUserStore.data" style="width : 150px; height : 150px" />
                        </div>

                        <form v-on:submit.prevent class="mt-4" enctype="multipart/form-data">
                            <button v-show="!state.form.values.profile_pict" @click="triggerInputProfilePict()"
                        ...
                        <p v-if="state.form.errors.profile_pict" class="mt-4">{{ state.form.errors.profile_pict }}</p>
                    </div>
                </div>
            </div>
        </div>
