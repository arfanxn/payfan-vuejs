<template>
    <div class="ms-4 p-5">
        ...
        <SearchPeoples :showButton="true" @contactClicked="(contact) => requestPaymentPreview(contact['user'])"
            @peopleClicked="requestPaymentPreview" />
        <RecentContacts @contactClicked="(contact) => requestPaymentPreview(contact['user'])" class="mt-5" />
        <TransferPreviewModal @nextClicked="handleMakeRequestPayment" :user="state.modal.transferPreviewModal.user">
