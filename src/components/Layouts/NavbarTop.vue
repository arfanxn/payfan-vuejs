    ...
    <teleport to="#navbar-top">
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-navy">
            <div class="container-md navbar-custom-container">
                <router-link class="navbar-brand fw-bold fs-3" active-class="none" exact-active-class="none"
                    :to="state.navbars[0]['link']">{{ Helpers.ENV("APP_TITLE") }}</router-link>
                ...
                <div class="collapse navbar-collapse d-md-flex justify-content-between" id="navbarNavAltMarkup">
                    <div class="navbar-nav d-flex justify-content-end">
                        <router-link v-for="(navb, index ) in state.navbars"
                            :id="navb.text == `Send and Request` ? `NavLinkSendandRequest` : null" :key="index"
                    ...
                    <div class="navbar-nav">
                        ...
                        <router-link active-class="none" exact-active-class="none" to="/account/settings"
                            class="cursor-pointer nav-link fw-bold fs-6 d-flex px-0 mx-1 invert-100">
                            <img class="nav-link-icon my-auto" src="@/assets/icons/settings.png" alt="Settings" />
                        </router-link>
                        <a class="cursor-pointer nav-link fw-bold fs-6 px-0 ms-2 me-1" @click.prevent="handleLogout()">
                            <small>LOG OUT</small>
                        </a>
                    </div>
                </div>
